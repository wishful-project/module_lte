...
'''
    ...
    def HSS_activation(self):
        ...
        os.system('cd /home/frcgnn/openair-cn/SCRIPTS && ./run_hss && ./run_mme && ./run_spgw')

        print("HSS_Activation")
...
@wishful_module.bind_function(upis.net.EPC_activation)
def EPC_activation(self):
    # print("Building of the EPC is in progress")

    # os.system("The HSS building log file could be find in /usr/local/etc/oai/hss_build_log.txt")

    # os.system("The  MME building log file could be find in /usr/local/etc/oai/mme_build_log.txt")

    # os.system("The SP-GW building log file could be find in /usr/local/etc/oai/spgw_build_log.txt")

    # os.system('cd /home/frcgnn/openair-cn/SCRIPTS && ./build_hss -c > /usr/local/etc/oai/hss_build_log.txt && ./build_mme -c > /usr/local/etc/oai/mme_build_log.txt && ./build_spgw -c > /usr/local/etc/oai/spgw_build_log.txt')

    # print("Building of the EPC is done")



    print("Aactivation of the EPC in progress")

    os.system("The HSS activation log file could be find in /usr/local/etc/oai/hss_activation_log.txt")

    os.system("The  MME activation log file could be find in /usr/local/etc/oai/mme_activation_log.txt")

    os.system("The SP-GW activation log file could be find in /usr/local/etc/oai/spgw_activation_log.txt")

    os.system(
        'cd /home/frcgnn/openair-cn/SCRIPTS && ./run_hss > /usr/local/etc/oai/hss_activation_log.txt && ./run_mme > /usr/local/etc/oai/mme_activation_log.txt && ./run_spgw > /usr/local/etc/oai/spgw_activation_log.txt')

    return


@wishful_module.bind_function(upis.net.EPC_deactivation)
def EPC_deactivation(self):
    print("Deactivation of the EPC in progress")

    os.system('sudo pkill oai_hss && sudo pkill mme && sudo pkill spgw')

    print("Deactivation of the EPC done!")
...
def eNB_activation(self):
    os.system(
        'cd /home/wishful-agent/openairinterface5g/targets/bin/ && sudo -E ./lte-softmodem.Rel14 -O /home/wishful-agent/openairinterface5g/targets/PROJECTS/GENERIC-LTE-EPC/CONF/enb.band7.tm1.usrpb210.conf')
...
def RRU_activation(self):
    os.system(
        'cd /home/wishful-agent/openairinterface5g/targets/bin/ && sudo -E ./lte-softmodem.Rel14 -O /home/wishful-agent/openairinterface5g/targets/PROJECTS/GENERIC-LTE-EPC/CONF/rru.band7.tm1.usrpb210.conf')
...
def RCC_activation(self):
    os.system(
        'cd /home/wishful-agent/openairinterface5g/targets/bin/ && sudo -E ./lte-softmodem.Rel14 -O /home/wishful-agent/openairinterface5g/targets/PROJECTS/GENERIC-LTE-EPC/CONF/rcc.band7.tm1.usrpb210.conf')
